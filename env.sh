...
=======
let assetCanister = principal "sgymv-uiaaa-aaaaa-aaaia-cai";
let assetSc = record { canister_id = principal "sgymv-uiaaa-aaaaa-aaaia-cai" };
let assetStore = record { canister_id = principal "sbzkb-zqaaa-aaaaa-aaaiq-cai" };
let assetStoreCanister = principal "sbzkb-zqaaa-aaaaa-aaaiq-cai";
let dip20 = record { canister_id = principal "qvhpv-4qaaa-aaaaa-aaagq-cai" };
let dip20Canister = principal "qvhpv-4qaaa-aaaaa-aaagq-cai";
let dip721Canister = principal "q4eej-kyaaa-aaaaa-aaaha-cai";
let ic = principal "aaaaa-aa";
let marketplace = record { canister_id = principal "si2b5-pyaaa-aaaaa-aaaja-cai" };
let marketplaceCanister = principal "si2b5-pyaaa-aaaaa-aaaja-cai";
let nftSc = record { canister_id = principal "q4eej-kyaaa-aaaaa-aaaha-cai" };
let resp = variant { Ok = 5 : nat };
let stakingCanister = principal "q3fc5-haaaa-aaaaa-aaahq-cai";
let stakingSc = record { canister_id = principal "q3fc5-haaaa-aaaaa-aaahq-cai" };
>>>>>>> 58a3cea8ef392c73d30fe5bc0476996d2c7f8c59
