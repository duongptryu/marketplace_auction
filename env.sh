...
let assetStoreCanister = principal "qsgjb-riaaa-aaaaa-aaaga-cai";
...
let marketplace = record { canister_id = principal "qvhpv-4qaaa-aaaaa-aaagq-cai" };
let marketplaceCanister = principal "qvhpv-4qaaa-aaaaa-aaagq-cai";
